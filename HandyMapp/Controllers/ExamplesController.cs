...
namespace HandyMapp.Controllers
{
    public class ExamplesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Count")] Example example)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Count")] Example example)
        {
            if (id != example.Id)
            {
                return NotFound();
